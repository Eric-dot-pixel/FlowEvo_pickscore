...
### Rejected `r0006` vs incumbent `r0004`

- rejected round: `logs/flow_autotts/pickscore_sd35/history_autotts_b64_fixed_target_reference_20260527_160759/r0006_20260527_160800_ffd4e330`
...
| ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| 0.500 | 0.836165 | 0.837384 | -0.001219 | 35.644 | 36.000 | below-target | forward -1.00, preview +0.64 | likely too little compute versus the baseline-matched reference |
| 0.750 | 0.840072 | 0.840149 | -0.000077 | 47.414 | 47.430 | below-target | no large action-count change | likely too little compute versus the baseline-matched reference |
| 1.000 | 0.842771 | 0.843016 | -0.000245 | 62.854 | 63.554 | below-target | mean_nfe -0.70 | likely too little compute versus the baseline-matched reference |
