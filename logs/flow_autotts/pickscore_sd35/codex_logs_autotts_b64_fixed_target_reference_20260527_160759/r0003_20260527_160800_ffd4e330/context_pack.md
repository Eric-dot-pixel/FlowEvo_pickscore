...
| ---: | ---: | --- | ---: | ---: | ---: |
| 0.000 | 10.000 | r0002 | 10.000 | 0.787971 | 0.111510 |
| 0.250 | 20.000 | r0002 | 20.000 | 0.801358 | -0.000725 |
...
| ---: | --- | ---: | ---: | ---: | ---: | --- | ---: | --- |
| 0.750 | r0002 | 47.000 | 48.000 | 0.834103 | -0.009887 | r0000 | 0.841569 | below reference NFE; likely underusing compute versus baseline |
| 1.000 | r0002 | 63.994 | 64.000 | 0.843780 | -0.003510 | r0000 | 0.844569 | below reference NFE; likely underusing compute versus baseline |
| 0.250 | r0002 | 20.000 | 20.000 | 0.801358 | -0.000725 | r0002 | 0.801358 | near reference NFE but still below baseline reward |
| 0.500 | r0002 | 36.000 | 36.000 | 0.836899 | 0.000250 | r0000 | 0.839043 | already at/above beta-matched baseline |
| 0.000 | r0002 | 10.000 | 10.000 | 0.787971 | 0.111510 | r0002 | 0.787971 | already at/above beta-matched baseline |

## Regression Ledger

| beta | latest_round | latest_nfe | latest_reward | prev_round | prev_nfe | prev_reward | reward_delta | nfe_delta | beta_target_reward |
| ---: | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 0.000 | r0002 | 10.000 | 0.787971 | r0000 | 10.000 | 0.778068 | 0.009903 | 0.000 | 0.676462 |
| 0.250 | r0002 | 20.000 | 0.801358 | r0000 | 20.000 | 0.789670 | 0.011689 | 0.000 | 0.802083 |
| 0.500 | r0002 | 36.000 | 0.836899 | r0000 | 36.000 | 0.839043 | -0.002144 | 0.000 | 0.836650 |
| 0.750 | r0002 | 47.000 | 0.834103 | r0000 | 48.000 | 0.841569 | -0.007466 | -1.000 | 0.843990 |
| 1.000 | r0002 | 63.994 | 0.843780 | r0000 | 64.000 | 0.844569 | -0.000789 | -0.006 | 0.847290 |
...
| --- | --- | --- |
| `spawn` | none | none |
| `forward` | 5 cases; mean action +19.54; mean Δreward=+0.002238; mean Δnfe=-0.20 | none |
| `preview` | 3 cases; mean action +1.33; mean Δreward=+0.006483; mean Δnfe=+0.00 | 2 cases; mean action -1.85; mean Δreward=-0.004128; mean Δnfe=-0.50 |
| `backward` | 3 cases; mean action +1.57; mean Δreward=-0.003467; mean Δnfe=-0.34 | none |
| `prune` | none | 2 cases; mean action -1.00; mean Δreward=-0.004128; mean Δnfe=-0.50 |
...
| 0.250 | `preview` | increase | 1 | 2.00 | 0.011689 | 0.000 |
| 0.500 | `backward` | increase | 1 | 1.39 | -0.002144 | 0.000 |
| 0.500 | `forward` | increase | 1 | 20.00 | -0.002144 | 0.000 |
| 0.500 | `preview` | increase | 1 | 1.00 | -0.002144 | 0.000 |
| 0.750 | `backward` | increase | 1 | 1.33 | -0.007466 | -1.000 |
| 0.750 | `forward` | increase | 1 | 27.00 | -0.007466 | -1.000 |
...
| 1.000 | `forward` | increase | 1 | 35.70 | -0.000789 | -0.006 |
...
| --- | ---: | --- | ---: | ---: | --- |
| r0000->r0002 | 0.500 | preview +1.00 | -0.002144 | 0.000 | forward +20.0, backward +1.4 |
| r0000->r0002 | 0.500 | backward +1.39 | -0.002144 | 0.000 | forward +20.0, preview +1.0 |
| r0000->r0002 | 0.750 | forward +27.00 | -0.007466 | -1.000 | preview -1.0, backward +1.3, prune -1.0 |
| r0000->r0002 | 0.750 | preview -1.00 | -0.007466 | -1.000 | forward +27.0, backward +1.3, prune -1.0 |
| r0000->r0002 | 0.750 | backward +1.33 | -0.007466 | -1.000 | forward +27.0, preview -1.0, prune -1.0 |
| r0000->r0002 | 0.750 | prune -1.00 | -0.007466 | -1.000 | forward +27.0, preview -1.0, backward +1.3 |
| r0000->r0002 | 1.000 | forward +35.70 | -0.000789 | -0.006 | preview -2.7, backward +2.0, prune -1.0 |
| r0000->r0002 | 1.000 | preview -2.71 | -0.000789 | -0.006 | forward +35.7, backward +2.0, prune -1.0 |
| r0000->r0002 | 1.000 | backward +2.00 | -0.000789 | -0.006 | forward +35.7, preview -2.7, prune -1.0 |
| r0000->r0002 | 1.000 | prune -1.00 | -0.000789 | -0.006 | forward +35.7, preview -2.7, backward +2.0 |
