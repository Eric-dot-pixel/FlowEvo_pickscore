...
| ---: | ---: | --- | ---: | ---: | ---: |
| 0.000 | 10.000 | r0003 | 10.000 | 0.787971 | 0.111510 |
| 0.250 | 20.000 | r0003 | 20.000 | 0.817857 | 0.015774 |
...
| ---: | --- | ---: | ---: | ---: | ---: | --- | ---: | --- |
| 0.500 | r0003 | 36.000 | 36.000 | 0.832135 | -0.004514 | r0000 | 0.839043 | same beta has a stronger prior round near the reference NFE |
| 1.000 | r0003 | 63.000 | 64.000 | 0.843447 | -0.003843 | r0000 | 0.844569 | below reference NFE; likely underusing compute versus baseline |
| 0.750 | r0003 | 46.640 | 48.000 | 0.840608 | -0.003382 | r0000 | 0.841569 | below reference NFE; likely underusing compute versus baseline |
| 0.250 | r0003 | 20.000 | 20.000 | 0.817857 | 0.015774 | r0003 | 0.817857 | already at/above beta-matched baseline |
| 0.000 | r0003 | 10.000 | 10.000 | 0.787971 | 0.111510 | r0003 | 0.787971 | already at/above beta-matched baseline |

## Regression Ledger

| beta | latest_round | latest_nfe | latest_reward | prev_round | prev_nfe | prev_reward | reward_delta | nfe_delta | beta_target_reward |
| ---: | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 0.000 | r0003 | 10.000 | 0.787971 | r0002 | 10.000 | 0.787971 | 0.000000 | 0.000 | 0.676462 |
| 0.250 | r0003 | 20.000 | 0.817857 | r0002 | 20.000 | 0.801358 | 0.016498 | 0.000 | 0.802083 |
| 0.500 | r0003 | 36.000 | 0.832135 | r0002 | 36.000 | 0.836899 | -0.004764 | 0.000 | 0.836650 |
| 0.750 | r0003 | 46.640 | 0.840608 | r0002 | 47.000 | 0.834103 | 0.006505 | -0.360 | 0.843990 |
| 1.000 | r0003 | 63.000 | 0.843447 | r0002 | 63.994 | 0.843780 | -0.000333 | -0.994 | 0.847290 |
...
| --- | --- | --- |
| `spawn` | none | none |
| `forward` | 5 cases; mean action +19.54; mean Δreward=+0.002238; mean Δnfe=-0.20 | 4 cases; mean action -2.15; mean Δreward=+0.004477; mean Δnfe=-0.34 |
| `preview` | 7 cases; mean action +1.60; mean Δreward=+0.005336; mean Δnfe=-0.19 | 2 cases; mean action -1.85; mean Δreward=-0.004128; mean Δnfe=-0.50 |
| `backward` | 3 cases; mean action +1.57; mean Δreward=-0.003467; mean Δnfe=-0.34 | 1 cases; mean action -1.00; mean Δreward=-0.000333; mean Δnfe=-0.99 |
...
| 1.000 | `backward` | decrease | 1 | -1.00 | -0.000333 | -0.994 |
...
| --- | ---: | --- | ---: | ---: | --- |
| r0002->r0003 | 0.250 | forward -1.00 | 0.016498 | 0.000 | preview +1.0 |
| r0002->r0003 | 0.250 | preview +1.00 | 0.016498 | 0.000 | forward -1.0 |
| r0002->r0003 | 0.500 | forward -1.00 | -0.004764 | 0.000 | preview +1.0, prune -0.8 |
| r0002->r0003 | 0.500 | preview +1.00 | -0.004764 | 0.000 | forward -1.0, prune -0.8 |
| r0002->r0003 | 0.500 | prune -0.82 | -0.004764 | 0.000 | forward -1.0, preview +1.0 |
| r0002->r0003 | 0.750 | forward -2.18 | 0.006505 | -0.360 | preview +1.8 |
| r0002->r0003 | 0.750 | preview +1.82 | 0.006505 | -0.360 | forward -2.2 |
